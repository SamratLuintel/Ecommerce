      ...
      <Fragment>
        <div
          className={classnames({
            "AdminSideNav__expand-left-nav-btn": true,
            "AdminSideNav__expand-left-nav-btn--visible": this.state.shrinked
          })}
          onClick={() => this.onShrink(false)}
        >
